...
exports.registerUser = async (req, res) => {
  try {
    ...
    try {
        ...
        const message = `
ውድ የአደይ ቢንጎ ቤተስቦች እንኩዋን 🔥🔥🔥ለብርሃነ መስቀሉ  በሰላም አደረሳችሁ
እንሆ በአዲስ ነገር መጥተናል ከፍተኛ ተጫዋቾቸን እና አሸናፊዎቸን ለማብርታታት ስንል 
ዘውትር ማክሰኞ እና አርብ የተሻለ ኮይን ያላችውን አምስት ምርጦች 💰💰💰💰💰የምንሸልም  ይሆናል።
1  ጨዋታ ሲጫወቱ 1 ኮይን  
🎁 ይሰጦታል 
ሲያሽንፉ ተጨማሪ ሌላ ኮይን ይኖሮታል 🎁
Leaders board  የሚልውን  በመንካት
በሰአቱ እየመሩ ያሉትን ተጫዋቾች  መመልከት ይችላሉ።
የሪፈራል ሊንክ ቦነሳችን እንደተጠበቀ ነው 
ከ1 በላይ ካርቴላ መምረጥ እንደምትቸሉ ሳይነጋ።
